...
def main():
    ...
    for i in range(1, 7981):
        temp_e = i % 15 if i % 15 != 0 else 15
        temp_s = i % 28 if i % 28 != 0 else 28
        temp_m = i % 19 if i % 19 != 0 else 19
        if (temp_e, temp_s, temp_m) == (e, s, m):
            print(i)
            return
...
if __name__ == "__main__":
    main()
'''
# 여러번 재사용 가능하게 아예 다 만들어둘까

def main():
    brute = [[0, 0, 0] for _ in range(7981)]
